...
set(handles.theta_1_slider, 'Min', -180, 'Max', 180, 'Value', 0, ...
    'SliderStep', [1/180, 1/180]);
set(handles.theta_2_slider, 'Min', -180, 'Max', 180, 'Value', 0, ...
    'SliderStep', [1/180, 1/180]);
set(handles.theta_3_slider, 'Min', -180, 'Max', 180, 'Value', 0, ...
    'SliderStep', [1/180, 1/180]);
